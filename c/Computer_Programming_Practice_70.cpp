/*
    File: Computer_Programming_Practice_70.cpp
...
int main ( )
{
    ...
    ofstream fout;
    fout.open ("amount_of_change_8.txt");
    ...
    fout << fixed << setprecision(2)
         ...
         << "--/--/--" << endl << endl << endl
         << "Receive $" << payment_amount / 100.0 << " for a purchase of $" << purchase_amount / 100.0 << endl << endl
    ...
    cout << endl << endl
         ...
         << "Lab Section: L07" << endl
         << "--/--/--" << endl << endl
         << "Program results have been to written to amount_of_change_8.txt" << endl;
