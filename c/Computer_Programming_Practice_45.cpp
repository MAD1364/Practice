/*
    File: Computer_Programming_Practice_45.cpp
...
int main ( )
{
    ...
    ofstream fout;
    fout.open ("amount_of_change_4.txt");
    ...
    fout << "Received " << payment_amount / 100.0 << " for a purchase of " << purchase_amount / 100.0 << "." << endl << endl
    ...
    cout << "Program results have been written to the file amount_of_change_4.txt" << endl;
