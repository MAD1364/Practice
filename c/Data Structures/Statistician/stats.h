...
#ifndef STATS_H     // Prevent duplicate definition (guard directive)
#define STATS_H
#include <iostream>
...
namespace main_savitch_2C
{
    ...
    public:
        ...
        int length( ) const { return count; } // constructor can initialize to 0 since next has not been called when a statistician is instantiated
